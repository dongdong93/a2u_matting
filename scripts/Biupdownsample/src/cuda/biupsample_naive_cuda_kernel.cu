...
__global__ void BiupsampleNAIVEForward(const int nthreads,
...
int BiupsampleNAIVEForwardLaucher(const at::Tensor features, const at::Tensor masks,
                              const int kernel_size, const int group_size,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      features.scalar_type(), "BiupsampleNAIVELaucherForward", ([&] {
        const scalar_t *bottom_data = features.data_ptr<scalar_t>();
        const scalar_t *bottom_masks = masks.data_ptr<scalar_t>();
        scalar_t *top_data = output.data_ptr<scalar_t>();

        BiupsampleNAIVEForward<scalar_t>
...
template <typename scalar_t>
__global__ void BiupsampleNAIVEBackward(
...
int BiupsampleNAIVEBackwardLaucher(const at::Tensor top_grad,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      top_grad.scalar_type(), "BiupsampleNAIVELaucherBackward", ([&] {
        ...
        BiupsampleNAIVEBackward<scalar_t>
            <<<GET_BLOCKS(output_size), THREADS_PER_BLOCK>>>(
